...
/*   Updated: 2025/05/02 13:58:33 by zsonie           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
memory area
       dest.  The memory areas may overlap: copying  takes  place  as  
	   though  the
...
** @return The strlcpy() return the total
 length of the string tried to create. For strlcpy() that means the length
  of src.
*/
